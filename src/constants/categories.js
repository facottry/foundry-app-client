// Category slogans for SEO and UX
export const CATEGORY_SLOGANS = {
    'DevTools': 'Tools that remove friction, not add complexity.',
    'Productivity': 'Build faster with fewer moving parts.',
    'Marketing': 'Get discovered without shouting.',
    'AI': 'Intelligence that serves, not replaces.',
    'SaaS': 'Software that respects your time.',
    'all': 'Discover the next generation of tools.'
};

// Category intro copy for landing pages
...
export const CATEGORY_TITLES = {
    'DevTools': 'Developer Tools Built for Builders',
    'Productivity': 'Productivity Tools That Respect Focus',
    'Marketing': 'Growth Tools for Sustainable Discovery',
    'AI': 'AI Tools Built for Real Outcomes',
    'SaaS': 'SaaS Products That Respect Users',
    'all': 'Explore Products Built by Independent Founders'
};

// Category slugs mapping (for future use when implementing slug-based routing)
